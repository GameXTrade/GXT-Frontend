...
function Me() {
    ...
    return (
        <div className='flex w-full bg-gray-100 justify-center' style={{height: "calc(100dvh - 64px)"}}>
            ...
            <aside id="default-sidebar" style={{height: "calc(100dvh - 64px)"}} className="fixed left-0 z-40 top-16 w-64  transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
                <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                        <li>
                            <div className="flex cursor-pointer items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group" onClick={()=> setshowItems(true)}>
                                ...
                                <span className="ml-3">My Items</span>
                            </div>
                        </li>
                        <li>
                            <div className="flex cursor-pointer items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group" onClick={() => setShowItemForm(true)}>
                                <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path></svg>
                                <span className="ml-3">Create Item</span>
                            </div>
                        </li>
                        <li>
